Feature: Dashboard
  ...
  Scenario: _setup
    Given I switch to the user browser
      And I create a started user "Dashboard Collection Point", "dashboard-collection-point", "dashboard-collection-point@example.com" with password "123123ab"
  ...
  Scenario Outline: Dashboard information
    ...
    Given I freeze time at <date>
      ...
      And I login with "dashboard-collection-point@example.com" and "123123ab"
   ...
   Examples: Times where you can make changes for the next collection
     ...
     | 2016-07-17 14:59:59 | Sunday    | Wednesday              | Wednesday                        | 3pm today       | next week's collection    |
     | 2016-07-17 14:59:59 | Sunday    | Thursday               | Thursday                         | 3pm today       | next week's collection    |
     | 2016-07-17 14:59:59 | Sunday    | Wednesday and Thursday | Wednesday and Thursday           | 3pm today       | next week's collection    | 
     | 2016-07-17 15:00:00 | Sunday    | Wednesday              | Wednesday                        | 3pm next Sunday | the collection after next |
     | 2016-07-17 15:00:00 | Sunday    | Thursday               | Thursday                         | 3pm next Sunday | the collection after next |
     | 2016-07-17 15:00:00 | Sunday    | Wednesday and Thursday | Wednesday and Thursday           | 3pm next Sunday | the collection after next |
